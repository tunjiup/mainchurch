...
$members = $db->arraybuilder()->paginate("members", $page, $select);
        ...
        <tbody>
            <?php foreach ($members as $row) : ?>
                <tr>
	                ...
	                <td>
					<a href="edit_member.php?member_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
